    ...
    <div class="wrapper">
        ...
        if (isset($_POST['submit'])) {
            ...
            if (isset($_FILES['image']['name'])) {
                ...
                $destination_path = "../restaurant-img/category-restaurant/" . $image_name;
        
                if (move_uploaded_file($source_path, $destination_path)) {
                    // Image uploaded successfully.
                } else {
                    $_SESSION['upload'] = "<div class='error'>Failed to upload image</div>";
                    header('location: ' . SITEURL . 'admin/add-restaurant-category.php');
                    die();
                }
            } else {
            ...
            $sql = "INSERT INTO tbl_category_restaurant (title, image_name, description, featured, active) VALUES (?, ?, ?, ?, ?)";
            $stmt = mysqli_prepare($conn, $sql);
            mysqli_stmt_bind_param($stmt, "sssss", $title, $image_name, $description, $featured, $active);
